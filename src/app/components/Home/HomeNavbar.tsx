          ...
          <Col className="navbar">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="ml-auto" style={{ backgroundColor: "#0D378D1F", borderRadius: "30px", height: "60px", paddingTop: "9px" }}>
                ...
                <Nav.Link as={Link} to="/#" className='mx-5'>About</Nav.Link>
                <Nav.Link as={Link} to="/#" className='mx-5'>Services</Nav.Link>
                <Nav.Link as={Link} to="/#" className='mx-5'>Gallery</Nav.Link>
                <Nav.Link as={Link} to="/#" className='mx-5'>Blog</Nav.Link>
                <Nav.Link as={Link} to="/#" className='mx-5'>Contact</Nav.Link>
              </Nav>
            </Navbar.Collapse>
          </Col>
