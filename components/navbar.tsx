  ...
  return (
    <>
      ...
      <header className="bg-white py-2 px-4 md:px-8 sticky top-0 z-[99999] shadow-lg">
        <div className=" mx-auto flex items-center justify-between cont-main">
          ...
          <div className="flex lg:space-x-60   menu-btn">
            <nav className="hidden lg:flex items-center space-x-14    bg-[#0D378D1F] rounded-4xl px-5.5 py-3.5 menubar">
              <Link
                href="/"
                className={` ${currentPath == '/' ? 'text-[#0D378D]' : 'text-black' } hover:text-[#0D378D]  font-medium nav-text`}
              >
                Home
              </Link>
              <Link
                href="/about"
                className={` ${currentPath == '/about' ? 'text-[#0D378D]' : 'text-black' } hover:text-[#0D378D]  font-medium nav-text`}
              >
                About
              </Link>
              <Link
                href="/services"
                className={` ${currentPath == '/services' ? 'text-[#0D378D]' : 'text-black' } hover:text-[#0D378D]  font-medium nav-text`}
              >
                Services
              </Link>
              <Link
                href="/gallery"
                className={` ${currentPath == '/gallery' ? 'text-[#0D378D]' : 'text-black' } hover:text-[#0D378D]  font-medium nav-text`}
              >
                Gallery
              </Link>
              <Link
                href="/blogs"
                className={` ${currentPath == '/blogs' ? 'text-[#0D378D]' : 'text-black' } hover:text-[#0D378D]  font-medium nav-text`}
              >
                Blog
              </Link>
              <Link
                href="/contact"
                className={` ${currentPath == '/contact' ? 'text-[#0D378D]' : 'text-black' } hover:text-[#0D378D]  font-medium nav-text`}
              >
                Contact
              </Link>
            </nav>

            <div className="hidden lg:flex items-center space-x-9 btn-img-nav">
              <div className="flex items-center space-x-3 call-icon-text">
              ...
              >
                <Button className="cursor-pointer aj-text">Book Now</Button>
              </Link>
