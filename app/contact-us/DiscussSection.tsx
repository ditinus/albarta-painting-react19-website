...
//       <h2 className="text-center text-4xl font-medium text-[#0D378D] mb-8">
//         Let’s Discuss Your Project Today!
//       </h2>
//       <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 justify-center items-center">
//         <div className="text-center">
//           <div className="icon mb-4">
//             <Image src={PhoneLogo} alt="Call Us" style={{ margin: "auto" }} />
//           </div>
//           <h3 className="text-[#000000] text-4xl">CALL US</h3>
//         </div>

//         <div className="text-center">
//           <div className="icon mb-4">
//             <Image src={EmailLogo} alt="Email Us" style={{ margin: "auto" }} />
//           </div>
//           <h3 className="text-[#000000] text-4xl">EMAIL US</h3>
//         </div>

//         <div className="text-center">
//           <div className="icon mb-4">
//             <Image src={DirectionLogo} alt="Get Directions" style={{ margin: "auto" }} />
//           </div>
//           <h3 className="text-[#000000] text-4xl">GET DIRECTIONS</h3>
//         </div>
//       </div>
//     </section>
//   );
...
//               alt="Call Us"
//               style={{margin:"auto"}}
//               className="w-24 h-24 sm:w-32 sm:h-32 " // adjust the image size
//             />
//           </div>
//           <h3 className="text-[#000000] text-4xl">CALL US</h3>
//         </div>
